...
<div role="main" class="main">
    ...
    <div class="custom-slider-background-image-stage-outer appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="1600">
        <div class="custom-slider-background-image-stage">
            <div class="custom-slider-background-image-item overlay overlay-show overlay-op-6" style="background-image: url('{{ asset('img/demos/architecture-2/slides/slide-1-1.jpg') }}'); background-size: cover; background-position: center;"></div>
            <div class="custom-slider-background-image-item overlay overlay-show overlay-op-6" style="background-image: url('{{ asset('img/demos/architecture-2/slides/slide-1-2.jpg') }}'); background-size: cover; background-position: center;"></div>
            <div class="custom-slider-background-image-item overlay overlay-show overlay-op-6" style="background-image: url('{{ asset('img/demos/architecture-2/generic/generic-1.jpg') }}'); background-size: cover; background-position: center;"></div>
            <div class="custom-slider-background-image-item overlay overlay-show overlay-op-6" style="background-image: url('{{ asset('img/demos/architecture-2/generic/generic-2.jpg') }}'); background-size: cover; background-position: center;"></div>
        </div>
    </div>
    <div class="custom-slider-background-image-stage-outer appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="1600">
